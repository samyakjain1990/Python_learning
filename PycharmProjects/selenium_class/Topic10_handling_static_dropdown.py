...
try:
    ...
    # value can only be used if inspect shows the dropdown has an value tag. please make user verifies if there is any tab with values for the dropdown 
    ...
    # Assertion to check if the text is returned from the form.
    assert "SuccessA" in formtext

except :
    print("The output printed by the form is not correct")
